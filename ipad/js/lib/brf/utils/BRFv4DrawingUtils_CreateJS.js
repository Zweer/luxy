(function() {
    "use strict";
	window.brfv4.example = {drawing: {}};
    var drawing = brfv4.example.drawing;
    ...
    drawing.drawTriangles = function(vertices, triangles, clear, lineThickness, lineColor, lineAlpha, fillColor, fillAlpha) {
        ...
        fillColor = defaultValue(fillColor, 0);
        fillAlpha = defaultValue(fillAlpha, 0);
    ...
    drawing.drawTrianglesTexture = function(vertices, triangles, uvData, texture) {
    ...
    drawing.drawTrianglesAsPoints = function(vertices, radius, clear, fillColor, fillAlpha) {
        clear = defaultValue(clear, false);
    ...
    drawing.drawRects = function(rects, clear, lineThickness, lineColor, lineAlpha) {
        clear = defaultValue(clear, false);
        lineThickness = defaultValue(lineThickness, 1.0); // "#00f6ff"
        lineColor = defaultValue(lineColor, 0x00a0ff); // "#00f6ff"
        lineAlpha = defaultValue(lineAlpha, 1.0);
    ...
    drawing.drawPoint = function(point, radius, clear, fillColor, fillAlpha) {
        clear = defaultValue(clear, false);
        fillColor = defaultValue(fillColor, 0x00a0ff); // "#00f6ff"
