	...
	example.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		for(var i = 0; i < faces.length; i++) {
			...
			if(face.state == brfv4.BRFState.FACE_TRACKING_START ||
				...
				draw.drawTriangles(			_extendedShape.vertices, _extendedShape.triangles, false, 1.0, 0x00a0ff, 0.4, 0, 0);
				draw.drawTrianglesAsPoints(	_extendedShape.vertices, 2.0, false, 0x00a0ff, 0.4);
			}
		}
	};

	dom.updateHeadline("BRFv4 - basic - face tracking - extended face shape\n" +
