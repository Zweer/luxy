(function exampleCode() {
	...
	var faceTex = brfv4.example.faceTextures.marcel_0;
	...
	example.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		for(var i = 0; i < faces.length; i++) {
			...
			if(	face.state == brfv4.BRFState.FACE_TRACKING_START ||
				...
				// draw.drawTrianglesTexture(face.vertices, face.triangles, faceTex.uv, texture);
				...
				draw.drawTrianglesTexture(face.vertices, triangles, faceTex.uv, texture);
			}
		}
	};

	dom.updateHeadline("BRFv4 - advanced - a face texture overlay.\n" +
